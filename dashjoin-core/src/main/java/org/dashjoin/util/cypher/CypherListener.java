...
/**
 * This interface defines a complete listener for a parse tree produced by {@link CypherParser}.
 */
public interface CypherListener extends ParseTreeListener {
   ...
   * @param ctx the parse tree
   */
  void enterOC_MultiplyDivideModuloExpression(
   ...
   * @param ctx the parse tree
   */
  void exitOC_MultiplyDivideModuloExpression(
      CypherParser.OC_MultiplyDivideModuloExpressionContext ctx);
   ...
   * @param ctx the parse tree
   */
  void enterOC_UnaryAddOrSubtractExpression(
   ...
   * @param ctx the parse tree
   */
  void enterOC_StringListNullOperatorExpression(
   ...
   * @param ctx the parse tree
   */
  void exitOC_StringListNullOperatorExpression(
      CypherParser.OC_StringListNullOperatorExpressionContext ctx);
