...
public class ProviderDatabaseTest {
  ...
  public void testQueryMap() throws Exception {
    ...
    info.query = "table";
    Assertions.assertEquals("{x={ID=x, name=n}}", "" + db.queryMap(info, of("ID", "x")));
    info.query = "table/x";
    Assertions.assertEquals("{x={ID=x, name=n}}", "" + db.queryMap(info, of("ID", "x")));
    info.query = "table/notthere";
    Assertions.assertEquals("{}", "" + db.queryMap(info, of("ID", "x")));
  }
  ...
  public void testImmutable() throws Exception {
    ...
    Assertions.assertEquals("n", object.get("name"));
  }
}
